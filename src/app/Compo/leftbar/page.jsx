...
const Lefti = () => {
  ...
  return (
    <div>
            <div className='p-3 sidebar z-50 bg-white dark:bg-black w-full block sm:block md:block lg:hidden xl:hidden 2xl:hidden h-screen' style={{transition: "0.3s ease-in ", top: "0%", transform: lefti ? 'translateX(0%)' : 'translateX(-100%)', }}>
